...
import { AuscultationTabComponent } from '../tabs/auscultation-tab/auscultation-tab';
import { ExamCameraTabComponent } from '../tabs/exam-camera-tab/exam-camera-tab';
...
@Component({
  ...
  imports: [
    ...
    AuscultationTabComponent,
    ExamCameraTabComponent
  ],
